export const site = {
  ...
  contactTeaser: 'If something here made you curious, say hello.',
  contactBody:
    'I read my email. If a piece of writing raised a question or you just want to talk through an idea, send a note. Tell me what prompted it. I try to reply.',
} as const;
